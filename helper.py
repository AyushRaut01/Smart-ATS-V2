...
def prepare_prompt(resume_text, job_description):
    ...
    {{
        "JD Match": "percentage between 0-100, representing how well the resume matches the job description",
        "MissingKeywords": ["list of keywords from the job description that are missing in the resume"],
        "Profile Summary": "detailed analysis of the match, including strengths, weaknesses, and specific suggestions for improvement",
        "Conclusion": "final recommendation based on the analysis (e.g., 'Strong Match', 'Moderate Match - Needs Improvement', 'Weak Match')"
    }}
    """
